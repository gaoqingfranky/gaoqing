...
dateTime.dateMsg=function () {
  ...
  var week=getweekday();
  msg=nowyear+'年'+nowmonth+'月'+nowday+'日'+week;
  return msg;
}
dateTime.dateMsg2=function () { //农历
  var msg='';
  var ludate=getLunarDateString(getLunarDate());
  msg='农历'+ludate.tg+ludate.dz+'年'+ludate.month+'月'+ludate.day;
  return msg;
};
...
function getLunarDate(date) {
  ...
  if (!date) {
    ...
    date = date.split('-'), year = parseInt(date[0]), month = parseInt(date[1]) - 1, day = parseInt(date[2]);
  }
